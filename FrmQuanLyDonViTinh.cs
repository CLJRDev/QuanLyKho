...
namespace QuanLyKho_Tuan1
{
    public partial class FrmQuanLyDonViTinh : Form
    {
        ...
        private void Load_Dgv_DonViTinh()
        {
        ...
        private void but_them_Click(object sender, EventArgs e)
        {
            if (this.check() == false)
                return;
            errorMes.Clear();
            string strCommand = "exec spThemDonViTinh @maDonViTinh,@tenDonViTinh";
            Dictionary<string, object> parameter = new Dictionary<string, object>();
            parameter.Add("@maDonViTinh", txt_maDonViTinh.Text);
            parameter.Add("@tenDonViTinh", txt_tenDonViTinh.Text);
            try
            {
                ...
                labMes.Text = "Status: Cap nhap du lieu thanh cong";
                Load_Dgv_DonViTinh();
            }
            catch(Exception ex)
            {
        ...
        private void but_sua_Click(object sender, EventArgs e)
        {
            if (this.check() == false)
                return;
            string strCommand = "exec spSuaDonViTinh @maDonViTinh, @tenDonViTinh";
            Dictionary<string, object> parameter = new Dictionary<string, object>();
            ...
            {
                errorMes.SetError(txt_tenDonViTinh, ex.Message);
                labMes.Text = "Status: Cap nhap du lieu that bai";
            }
        ...
        {
            string strDelete = "exec spXoaDonViTinh @maDonViTinh";
            Dictionary<string, object> parameter = new Dictionary<string, object>();
            parameter.Add("@maDonViTinh", dgv_DonViTinh.CurrentRow.Cells["MaDonViTinh"].Value.ToString());
            errorMes.Clear();
            try
            ...
            {
                labMes.Text = "Status: Lỗi xoá dữ liệu";
