...
@maLoaiHang varchar(3), @tenLoaiHang nvarchar(30)
as begin
	declare @dem int;
	...
	if @dem > 0
		...
		if @dem>0
			...
			insert LoaiHang values (@maLoaiHang, @tenLoaiHang);
	end
end
-----------------------------------------------------------------------------------------------------
create procedure spXoaLoaiHang @maLoaiHang varchar(3)
as begin
	declare @dem int;
...
GO
create procedure spSuaLoaiHang @maLoaiHang varchar(3), @tenLoaiHang nvarchar(30)
as begin
	declare @dem int;
	...
	if @dem>0
		...
		update LoaiHang set TenLoaiHang = @tenLoaiHang where MaLoaiHang = @maLoaiHang;
end
...
create procedure spThemDonViTinh @maDonViTinh varchar(3), @tenDonViTinh nvarchar(30)
as begin
	declare @dem int;
	...
	if @dem>0
		...
		if @dem>0
			...
			insert DonViTinh values (@maDonViTinh,@tenDonViTinh);
	end
end
-----------------------------------------------------------------------------------------------------
create procedure spXoaDonViTinh @maDonViTinh varchar(3)
as begin
	declare @dem int;
...
create procedure spSuaDonViTinh @maDonViTinh varchar(3), @tenDonViTinh nvarchar(30)
as begin
	declare @dem int;
	...
	if @dem>0
		...
		update DonViTinh set TenDonViTinh = @tenDonViTinh where MaDonViTinh = @maDonViTinh;
end
-------------------------------------------------------------------------------------------------------
create procedure spThemDonViTinhHangHoa @maHangHoa varchar(3), @maDonViTinh varchar(3)
as begin
	declare @dem int;
	...
	if @dem > 0
		...
		insert DonViTinhHangHoa values (@maHangHoa,@maDonViTinh);
end


create procedure spXoaDonViTinhHangHoa @maHangHoa varchar(3), @maDonViTinh varchar(3)
as begin
		delete DonViTinhHangHoa where MaHangHoa = @maHangHoa and MaDonViTinh = @maDonViTinh;
end

create procedure spThemLoaiHangHangHoa @maLoaiHang varchar(3), @maHangHoa varchar(3)
as begin
	declare @dem int;
	...
	if @dem > 0
		...
		insert LoaiHangHangHoa values (@maLoaiHang,@maHangHoa);
end

create procedure spXoaLoaiHangHangHoa @maLoaiHang varchar(3), @maHangHoa varchar(3)
as begin
...
create procedure spThemPhieuXuat @ngayXuat date, @nguoiNhanHang nvarchar(50), @noiNhan nvarchar(100), @maKho varchar(3), @thuKho nvarchar(30), @ghiChu nvarchar(100)
as begin
...
drop procedure [spThemChiTietPhieuXuat]
select * from PhieuXuat



create procedure spThemHangHoa @maHangHoa varchar(3), @tenHangHoa nvarchar(30)
as begin
	declare @dem int;
	...
	if @dem>0
		...
		if @dem > 0
			...
			insert HangHoa values (@maHangHoa,@tenHangHoa)
	end
end
create procedure spSuaHangHoa @maHangHoa varchar(3), @tenHangHoa nvarchar(30)
as begin
	declare @dem int;
	...
	if @dem > 0
		...
		update HangHoa set TenHangHoa = @tenHangHoa where MaHangHoa = @maHangHoa;
end

create procedure spXoaHangHoa @maHangHoa varchar(3)
as begin
	declare @dem int;
