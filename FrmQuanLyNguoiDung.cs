...
namespace QuanLyKho_Tuan1
{
    public partial class FrmQuanLyNguoiDung : Form
    {
        ...
        private void load_dgvNguoiDung()
        {
        ...
        private void lamMoi()
        {
            ck_quanLyNguoiDung.Checked = ck_quanLyLoaiHang.Checked = ck_quanLyKho.Checked = ck_quanLyHangHoa.Checked = ck_quanLyPhieuNhap.Checked = ck_quanLyPhieuXuat.Checked = ck_quanLyDonViTinh.Checked = false;
